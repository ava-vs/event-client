...
module {
    public class SubscriptionManager() = Self {
        ...
        // Unsubscribe a subscriber from a specific filter
        // public func unsubscribeByFilter(subscriber : Principal, filter : Types.EventFilter) : async Bool {
        //     let existingSubs = Option.get(subscriptions.get(subscriber), []);
        //     let filteredSubs = Array.filter<Types.SubscriptionInfo>(
        //         existingSubs,
        //         func(info : Types.SubscriptionInfo) : Bool {
        //             let match = Array.find<Types.EventFilter>(
        //                 info.filters,
        //                 func(f : Types.EventFilter) : Bool {
        //                     f.namespace == filter.namespace and f.eventType == filter.eventType and f.filterDetails == filter.filterDetails
        //                 },
        //             );
        //             match == null;
        //         },
        ...
        //         subscriptions.put(subscriber, filteredSubs);
        //     };
        //     // Return true if any filters were removed, otherwise return false
        //     return existingSubs.size() != filteredSubs.size();
        // };
